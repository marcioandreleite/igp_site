...
<main>
  ...
  <section class="igp-who">
    <header id="sobre" class="igo-who__header">
      <img src="${u}" width="230" title="isgamepost.com" alt="isgamepost.com" />
    </header>
    <div>
      <article>
        <h3>A ISGAMEPOST</h3>
